...
export const BOARD_SQUARES: BoardSquare[] = [
  ...
  { id: 24, name: "Prangenbergs Büro", type: 'property', color: 'red', price: 240, houseCost: 150, rent: [20, 100, 300, 750, 925, 1100], mortgageValue: 120, group: 'red' },
  { id: 25, name: 'Sporthalle', type: 'railroad', color: 'railroad', price: 200, rent: [25, 50, 100, 200], mortgageValue: 100, group: 'railroad' },
  { id: 26, name: 'Tischtennis', type: 'property', color: 'yellow', price: 260, houseCost: 150, rent: [22, 110, 330, 800, 975, 1150], mortgageValue: 130, group: 'yellow' },
