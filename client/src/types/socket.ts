...
export interface ServerToClientEvents {
  ...
  'room:spectating': (payload: { roomCode: string; gameState: GameState; lobbyPlayers: Array<{ id: string; name: string; color: string; piece: string; isBot: boolean; isReady: boolean }> }) => void
